package br.com.microservices.orchestrated.InventoryService.core.messaging.out;

import br.com.microservices.orchestrated.InventoryService.config.kafka.KafkaProperties;
